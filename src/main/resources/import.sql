...
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'BlackDog', '狗', 'BLACK', '2017-01-01', '2018-03-10 12:00:00', '1', '北投區', 1, '成年', '大型', '公');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'YellowDog', '狗', 'YELLOW', '2017-02-01', '2018-03-10 13:00:00', '1', '左營區', 1, '成年', '大型', '公');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'WhiteDog', '狗', 'WHITE', '2017-03-01', '2018-03-10 14:00:00', '1', '大安區', 1, '成年', '中型', '母');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'BrownDog', '狗', 'BROWN', '2018-04-01', '2018-03-10 15:00:00', '3', '東區', 1, '成年', '大型', '公');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'BlackCat', '貓', 'BLACK', '2017-05-01', '2018-03-10 16:00:00', '8', '左營區', 1, '幼年', '中型', '母');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'BlueCat', '貓', 'BLUE', '2017-06-01', '2018-03-10 17:00:00', '8', '北投區',2, '老年', '大型', '公');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'OrangeCat', '貓', 'ORANGE', '2017-07-01', '2018-03-10 18:00:00', '1', '左營區',2, '幼年', '小型', '母');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'WhiteRabbit', '兔', 'BLACK', '2017-08-01', '2018-03-10 19:00:00', '15', '北投區',2, '幼年', '大型', '公');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'GreyRabbit', '兔', 'BLACK', '2017-09-01', '2018-03-10 20:00:00', '1', '西區',2, '老年', '大型', '公');
insert into animal(status, name, specie, color, found, upload, city_id, district, member_id, age, size, gender) values  ('開放認養', 'YellowBird', '鳥', 'BLACK', '2017-10-01', '2018-03-10 21:00:00', '3', '西區',2, '幼年', '小型', '母');
...
累了，用頭撞門，然後…主人就幫他開門了…主人邊開邊說：「他真好命捏，我就負責幫他開門…！！」XD','2015-04-16 00:00:00','2015-04-16 00:00:00',2,8,0,5,'https://i.imgur.com/aE4VGkC.jpg');

insert into article (subject,content,post_Time,UPDATE_TIME,MEMBER_ID,CLICK,THUMBS_QUANTITY,CATEGORY_ID,images) values ('養貓新手上路（認養貓咪的觀念＆帶貓咪回家要注意的事）','<h2>養貓新手上路（認養貓咪的觀念＆帶貓咪回家要注意的事＆貓咪的日常清潔與運動＆日常生活該怎麼照顧＆關於結紮這檔事＆貓咪生的什麼病？！）&nbsp;</h2><p>&nbsp;認養貓咪的觀念， 認養前，我們的10個約定：&nbsp;</p><ul><li>請給我一點時間，讓我瞭解你對我的要求</li><li>請信任我，這是我幸福的泉源</li><li>請不要忘記，我也是有血有肉的</li><li>在責罵前，請先試著瞭解我</li><li>請偶爾對我說說話，雖然我聽不懂，但我懂你的心</li><li>請不要打我，別忘了，我認真起來是比你還強壯的</li><li>請好好照顧我，當我逐漸變老時</li><li>請記住，你有你的工作、娛樂和朋友，但我就只有你</li><li>請想想，我的生命有10~15年，遺棄我會是對我最大的傷害</li><li>請在我最終離去前陪著我，這是我最後的心願。最後，請記得，我愛你。</li></ul><p>另外請注意：&nbsp;</p><ol><li>如家中已有貓咪者，家中的貓是否已完成疫苗注射？</li><li>隔離籠或小房間已準備妥當？</li><li>貓咪的水盆、飼料、貓砂盆是否已準備？</li><li>外出提籠是否已準備？</li><li>家俱可能會受傷的這件事，是否已準備包容?</li></ol><figure class="image"><img src="https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg" srcset="https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg/w_144 144w, https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg/w_224 224w, https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg/w_304 304w, https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg/w_384 384w, https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg/w_464 464w, https://16608.cdn.cke-cs.com/nZO2k5WiHIWjQYuCvKvS/images/a81ac234bdf90c5213d6d8474387727b6b0b4e291f7eb770_貓床2.jpg/w_544 544w" sizes="100vw" width="544"></figure>','2015-10-10 00:00:00','2015-10-10 00:00:00',2,51,0,2,'https://i.imgur.com/jp1wO6P.jpg');

insert into article (subject,content,post_Time,UPDATE_TIME,MEMBER_ID,CLICK,THUMBS_QUANTITY,CATEGORY_ID,images) values ('養狗知識: 狗狗動作及身體語言','<h3><i>你知道狗狗的很多動作其實是有特別意思的嗎? 以下是一些典型的犬隻肢體語言:&nbsp;</i></h3><ol><li>聞地面：這個動作被認為是當狗狗害怕對方（人或狗）時，想要使對方冷靜的信號。</li><li>一瞬間轉頭，把頭或眼睛轉向別方，有時這只是一瞬間的動作，可能您根本沒注意到這樣的行為。當小朋友跑向狗狗要抱牠時，害怕的狗狗可能就會有這樣的動作。 所以，請特別告誡小朋友，不要接近一隻瞪著你的陌生狗狗，"瞪著你"在狗狗的肢體語言就代表了攻擊性。當然，在沒有大人可隨時監看著的情況下，最好不要讓小朋友任意接近陌生的狗狗。&nbsp;</li><li>舔自己的鼻子：快或慢，都被認為是安撫陌生的對方的信號。而且有趣的是，黑色的狗狗會比其他毛色的狗狗更常使用這個動作。可能是因為黑色的狗狗比較不容易被看清楚臉部表情，而粉紅色的舌頭又特別明顯吧。&nbsp;</li><li>舔其他狗狗或人的臉：這普遍被認為是歡迎你的動作，有可能也是一個安撫的信號。&nbsp;</li><li>打呵欠：這是最普遍的一個正處於壓力下的信號。最常看到的時候就是在動物醫院、服從訓練中狗狗覺得主人要求太多、或被主人教訓時。&nbsp;</li><li>尾巴搖搖、兩腳站起、用前腳抓你：狗狗想要玩遊戲，表示想邀請你和他玩。熱情的狗狗，最希望你陪他一起玩，不管是你丟我撿、你跑我追、搶玩具。&nbsp;</li><li>翻著身子躺在地上，把肚子露出：狗狗認輸臣服的表示，肚子是狗狗最脆弱的地方，遇到老大或是比自己強勢的狗，認輸的一方便會躺在地上把肚子露出來，表示自己沒有敵意，你是老大般地向你釋出誠意。&nbsp;</li><li>尾巴搖動的速度越快：狗狗常常都是開心的，尤其是看到主人回家，幫他準備晚餐；或是聽到熟悉的腳步聲，知道你即將帶他出門散步。&nbsp;</li><li>露出牙齒低吼，或直接對目標狂吠：狗狗生氣，警告不要靠近，通常他們不會這樣對待你，但如果真的生氣了，狗狗會露出牙齒低吼示威。並不是真的要咬你，就像西部電影的牛仔生氣時，愛拔出武器示威一樣。&nbsp;</li><li>尾巴會垂下，屁屁向內弓：「夾著尾巴逃跑，先溜為妙」絕對是從狗狗得來的成語，狗狗感到害怕時，狀況不對先溜為妙。</li></ol>。','2018-05-07 00:00:00','2018-05-07 00:00:00',4,48,0,2,'https://i.imgur.com/NpK8a0G.jpg');

insert into article (subject,content,post_Time,UPDATE_TIME,MEMBER_ID,CLICK,THUMBS_QUANTITY,CATEGORY_ID,images) values ('請問養一隻狗開銷怎麼樣?','<p>問這問題是因為過去幾十年來, 從我爸小時候算起, 到現在我都快四十了, 我爸也當阿公了, 但我們家就是從來沒養過任何寵物. 所以自然對這方面的知識與經驗=0&nbsp;</p><p>其實我們家是蠻喜歡狗的, 兒子最近在嚷嚷說想養一隻, 只是一直沒有很認真的想要去做這件事. 能不能借這個版問一下, 請教各位, 先撇開購入幼犬的費用不計.....單純就幼犬抱回家之後, 大概每個月或每年要面臨哪些開銷啊? 能否用黃金獵犬跟威爾斯柯基犬, 這二種大小的狗, 讓我知道一下花費的預算大概會是多少啊? 非常感謝!!</p>','2018-03-07 00:00:00','2018-03-07 00:00:00',5,35,0,6,'https://i.imgur.com/e9i9jC5.jpg');
...
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('台北寵物用品博覽會', '2018/8/31', '台北世貿三館(110台北市信義區松壽路6號)', '匯集全台各大寵物用品廠商，提供最新寵物用品、飼料零食、保健營養品、服飾配件、美容清潔、住宿醫療等週邊服務。本展歡迎所有寵物愛好者攜帶寵物一同入場參觀！除了提供年度最優惠的商品促銷外，更規畫一系列與愛寵同歡的趣味活動，讓飼主與寵物能玩得開心、滿載而歸。除了讓各類參展商展示產品外，也是與業界合作交流、開發商機的管道。歡迎寵物相關業者預約洽談、換證入場。', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '200', '300' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('《狗狗的餐桌日常》新書分享會', '2018/9/3', '台北市士林區忠誠路二段55號4樓​ (紀伊國屋書店 台北天母店 (大葉高島屋4F)​)', '你也想親手幫狗狗做出美味的鮮食料理嗎？跑市場寵物店、Paw Kitchen寵物鮮食的負責人-- 陳彥姍，將投注於寵物鮮食料理上的熱情與經驗，集結成《狗狗的餐桌日常》與大家分享，讓主人可以從每天的飲食輕鬆把關狗的健康與營養，想為心愛的毛小孩準備健康食物，那就千萬不要錯過分享會啦！ ', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '0', '200' ); 
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('「集盒」2018城市貓貓 插畫展', '2018/1/28', '高雄市前鎮區復興三路五號 (IKEA對面)', '"貓奴們「集盒」! 城市貓貓插畫展 《2018城市貓貓 插畫展》1月28日起在高雄「集盒•Kubic」開展，靈動的貓貓插畫系列，每每展出皆獲得觀者共鳴！ 創作者李允榕將「心情日常」轉為創作靈感，透過插畫抒發心情與記錄城市生活。她將貓擬人化為都市人，現場展出的七十幅貓貓作品細膩靈動，反應出人生體悟，加上些許天馬行空的想像，令觀者會心一笑。創作者並以紙板搭建一座「貓樂園」象徵城市空間，並融入亞洲新灣區意象，讓貓咪成為一隻隻漫遊於高雄的城市觀察者，從貓的角度觀察一座城市的轉變，以插畫探索環境、城市及空間的關係。 展期從1月28日起至3月25日，免費參觀，歡迎貓迷們一起來探索。"', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '200', '600' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('高齡犬居家照護講座', '2018/11/19','台北市大同區迪化街一段14巷2號 (元氣樂活坊 / 捷運北門站3號出口，沿塔城街步行5~6分鐘)', '當您的狗兒年紀超過7歲，便已經踏入我們所稱的高齡犬階段。 或許您可能會覺得他們變得與年輕時期不同的個性又與我們生活緊密相連，但其實他們的活動力、生理機能、飲食內容、遊戲方式、醫療追蹤、生活互動等在不同年齡階段的需求各不相同，我們如何可以從細小的地方觀察狗兒的變化及增加心智刺激來調整照護他們高齡生活的方式呢 原本他尿尿都在固定的地點，但怎麼突然開始亂上廁所? 為什麼突然不想讓我摸他? 分離焦慮症變得愈來愈嚴重....... 這些高齡犬可能會遇到的行為問題， 我們應該了解如何去平衡之前可以而現在卻不行的狀況，並同時幫助狗兒老年生活開心。 講座中Molly老師將與毛爸媽們分享該如何調整心情來面對狗兒老化的種種憂心狀況，以及除了陪伴之外平時該如何照護高齡犬? 運用居家照護按摩及運動遊戲來豐富高齡犬的生活!', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '100', '300' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('高雄寵物用品博覽會', '2018/6/1', '高雄國際會議中心(803高雄市鹽埕區中正四路274號)', '匯集全台各大寵物用品廠商，提供最新寵物用品、飼料零食、保健營養品、服飾配件、美容清潔、住宿醫療等週邊服務。本展歡迎所有寵物愛好者攜帶寵物一同入場參觀！除了提供年度最優惠的商品促銷外，更規畫一系列與愛寵同歡的趣味活動，讓飼主與寵物能玩得開心、滿載而歸。除了讓各類參展商展示產品外，也是與業界合作交流、開發商機的管道。歡迎寵物相關業者預約洽談、換證入場。', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '160', '400' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('2018 展昭台北寵物用品展', '2018/7/6', '台北南港展覽館(11568台北市南港區經貿二路1號)', '全台最大寵物展策展團隊！超過20年寵物展主辦經驗，擁有專屬設計、資訊之整合行銷團隊。一次掌握北中南市場趨勢！首創北中南巡迴展出，整合全台資源，為您規劃年度行銷策略，直指台灣寵物產業核心。20萬毛家長口碑推薦！業界最具口碑之寵物用品展，全台唯一指標性寵物展。邀您一起，與超過500個國內外指標品牌比肩作戰，共享百億「毛」商機！', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '200', '300' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('高雄巨蛋寵物用品展', '2018/7/20', '高雄巨蛋（高雄市左營區博愛二路757號）', '7月20日（五）至 7月23日（一）即將在【高雄巨蛋】盛大登場！優質寵物商品超值大促銷，飼料、玩具、保健用品、服飾、美容、清潔用品一應俱全！廠商新品全都幫毛小孩準備好囉，廠商銅板商品更挑戰市場最低價，好康優惠絕對讓你搶不完！還有好玩的寵物嘉年華，專屬寵物寶貝的大操場，讓毛小孩有得逛、有得吃、更有得玩，快揪親朋好友一起來嗨翻高雄寵物展吧！', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '120', '600' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('台中寵物用品展', '2018/5/18', '大台中國際會展中心（台中市烏日區高鐵五路161號）', '匯集全台各大寵物用品廠商，提供最新寵物用品、飼料零食、保健營養品、服飾配件、美容清潔、住宿醫療等週邊服務。本展歡迎所有寵物愛好者攜帶寵物一同入場參觀！除了提供年度最優惠的商品促銷外，更規畫一系列與愛寵同歡的趣味活動，讓飼主與寵物能玩得開心、滿載而歸。除了讓各類參展商展示產品外，也是與業界合作交流、開發商機的管道。歡迎寵物相關業者預約洽談、換證入場。', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '100', '700' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('寵物家族大集合', '2018/7/7', '台北南港展覽館(11568台北市南港區經貿二路1號)', '寵物家族特別活動：2018台北寵物用品展，特別針對寵物家族舉辦好康展場活動！凡寵物家族至寵物展現場舉辦家聚，即有機會獲得貓狗漢方養生禮盒20盒！快跟著寵小汪與寵小喵瞧瞧活動內容吧！', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '200', '1500' );
INSERT INTO news (subject, event_Date, address, content, event_Time, publish_Date, publish_Expire, create_User, create_Time, ticket_Price, ticket_Quantity) 
values ('夏季寵物盛會', '2018/7/8', '台北南港展覽館(11568台北市南港區經貿二路1號)', '炎炎夏日，快帶家中寶貝來展場吹冷氣囉！不僅省電費還能搶超值優惠寵物商品，還有最萌寵物家族日、專屬毛寶貝的障礙趣味競賽，夏季唯一寵物嘉年華盛會', '2018-09-03 08:00:00', '2018-01-01', '2018-09-03', 'Admin', '2018-01-01 08:00:00', '200', '1500' );
...
insert into product (NAME, PRICE, STOCK, MAKE_DATE, EXPIRE, SHELVES_DATE, DESCRIPTION, NOTICE, classify_id, member_id, images)
values ('Mr. bear 寵寵熊半封閉開放式單層貓砂盆貓便盆', 590, 75, '2018-3-15',150, '2018-3-9', '產品尺寸：56cmX40cmX25cm', '25cm 超高防護蓋—兩片式雙層設計，更高防護，防貓咪帶出貓砂。可分離式設計—採用可拆卸雙層設計，清潔及搬運貓砂盆更為方便。弧形防污保護—弧形側邊及防落砂踏板可以防止貓咪帶出貓砂。大尺寸空間—寬鬆的空間尺寸讓各種體型的貓咪都可以活動自如。主動落砂踏板及大號貓砂鏟—讓貓咪舒適如廁。', 2, 2, 'https://i.imgur.com/0Eetpzu.jpg');
insert into product (NAME, PRICE, STOCK, MAKE_DATE, EXPIRE, SHELVES_DATE, DESCRIPTION, NOTICE, classify_id, member_id, images)
values ('IRIS 犬貓外出多功能兩用硬殼提籃(白色)', 1180, 36, '2018-3-15',365, '2018-2-10', '尺寸：48(W) x 32.1(D) x 30(H)cm', '◆透明頂部及側部可隨時觀察寵物舉動 ◆可讓寵物欣賞外面的風景 ◆設有卡扣可繫上汽車安全帶 ◆固定寵物位置確保行車安全 ◆頂部側部都設有門方便寵物進出 ◆平時在家可用作寵物屋，給寵物安全感', 2, 2, 'https://i.imgur.com/BWiRaj7.jpg');

insert into product (NAME, PRICE, STOCK, MAKE_DATE, EXPIRE, SHELVES_DATE, DESCRIPTION, NOTICE, classify_id, member_id, images)
values ('AFU 拉咬球 (顏色隨機出貨)', 69, 62, '2018-3-15',100, '2018-2-15', '尺寸：約 30 cm 重量：700 g 材質：棉繩 顏色：隨機出貨不挑色 注意事項：不可用機器浸泡清洗、避免受潮', '★ 啃咬，訓犬。★ 優質硬化棉繩，磨牙耐咬。★ 安全無毒材質使用，玩樂更安心。', 3, 2, 'https://i.imgur.com/fvIExGo.jpg');
insert into product (NAME, PRICE, STOCK, MAKE_DATE, EXPIRE, SHELVES_DATE, DESCRIPTION, NOTICE, classify_id, member_id, images)
values ('Petstages 耐咬史迪克 (XS)(迷你犬)', 162, 67, '2018-3-15',90, '2018-3-22', '實木與特殊合成材質 尺寸：L10 x W1.5 cm(適合4kg以下) 產地：中國製造/美國設計', '以真正的木頭合成，味道清新又耐咬！榮獲美國權威寵物雜誌Pet Product News票選2012年最佳推薦寵物商品。美國原廠專利材料製成。散發天然木頭香味。無毒合成材質，不會裂開刮傷狗狗牙齦。室內與室外玩耍都適合。', 3, 2, 'https://i.imgur.com/5R8NSwn.jpg');
insert into product (NAME, PRICE, STOCK, MAKE_DATE, EXPIRE, SHELVES_DATE, DESCRIPTION, NOTICE, classify_id, member_id, images)
values ('自然鮮 貓草薄荷球木天蓼健身棒棒糖', 99, 53, '2018-3-15',180, '2018-4-2', '清潔方式：不可直接水洗，可用濕布擦拭表面，再用日曬或烘乾機乾燥，香味就可以重新出現(請不要長時間曝曬於陽光下)。有機貓薄荷、木天蓼棒、人類食用膠 直徑：13.5cm(天然材料會有正負1cm的差距) 產地：台灣', '貓咪咬棒棒糖可以摩擦牙齒，達到清潔牙垢的功效。棒棒糖較不易遺失，貓咪可任意啃咬。人類食用等級膠黏著，可安心食用，貓咪玩耍時會有掉屑情況，屬正常現象。貓咪可利用玩耍棒棒糖而得到大量運動，消耗體能，增進食慾。', 3, 2, 'https://i.imgur.com/vAXhzfx.jpg');
insert into product (NAME, PRICE, STOCK, MAKE_DATE, EXPIRE, SHELVES_DATE, DESCRIPTION, NOTICE, classify_id, member_id, images)
