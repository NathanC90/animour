...
INSERT INTO CATEGORY(NAME) VALUES ('心情');
...
累了，用頭撞門，然後…主人就幫他開門了…主人邊開邊說：「他真好命捏，我就負責幫他開門…！！」XD','2015-04-16 00:00:00','2015-04-16 00:00:00',2,8,5,'https://imgur.com/n655T3i');
...
insert into article (subject,content,post_Time,UPDATE_TIME,MEMBER_ID,CLICK,CATEGORY_ID) values ('請問養一隻狗大概要花多少錢呢?','問這問題是因為過去幾十年來, 從我爸小時候算起, 到現在我都快四十了, 我爸也當阿公了, 但我們家就是從來沒養過任何寵物. 所以自然對這方面的知識與經驗=0 嘆氣

其實我們家是蠻喜歡狗的, 兒子最近在嚷嚷說想養一隻, 只是一直沒有很認真的想要去做這件事.

能不能借這個版問一下, 請教各位, 先撇開購入幼犬的費用不計.....單純就幼犬抱回家之後, 大概每個月或每年要面臨哪些開銷啊?

能否用黃金獵犬跟威爾斯柯基犬, 這二種大小的狗, 讓我知道一下花費的預算大概會是多少啊?

非常感謝!!','2018-03-07 00:00:00','2018-03-07 00:00:00',5,35,6);
...
insert into article (subject,content,post_Time,UPDATE_TIME,MEMBER_ID,CLICK,CATEGORY_ID,images) values ('想養刺蝟的人看過來~','想養刺蝟的人請先考慮以下三點:
1.刺蝟跟鼠類的寵物是不太一樣的，照顧上也會比較麻煩。例如:刺蝟的腸道短，跑輪輪的時候會一邊興奮一邊拉屎~所以天天都要清理便便風火輪。
2.刺蝟並不親人!!!通常網路上有名的刺蝟，那種在主人手上睡覺的都是比傳說卡還稀有的等級~一般刺蝟都很膽小，甚至有的飼主花了一年的時間他家刺刺還是鳥都不鳥他==...我們家的算溫和，只要被捧起來之後怎麼跟她玩都不會生氣:D
3.刺蝟的大便滿臭的，因為他是肉食性的，據說跟貓屎差不多。雖然我沒養過貓，但真的滿臭的。阿排只要一大便，我就聞得出來，還曾經清晨被便便臭醒過...QQ

如果已經再三考慮，打算進入飼養階段的話，那我再說說刺蝟入手的方式與飼養常見的問題。

入手方式基本上就是去寵物店買or等領養or等人家生的寶寶。
沒錯，刺蝟是可以領養的，而且機率並沒有想像中低。建議加入一些刺蝟fb社團，裡面很多機會:D
我個人是很不希望各位去寵物店購買，因為寵物店的刺蝟大都體弱多病，而且寵物店不只會推薦不適合的飼料，也會亂教你怎麼養!!!刺蝟絕對需要分籠飼養，但很多寵物店都隨便養，墊材跟窩都準備的很爛，也沒有保溫燈。就算你那兩隻感情好不會打架，刺蝟也是獨居動物，請尊重他們的習性。(但是有時候看到魚X魚裡面可憐的小東西，還是很想把他們拯救出來...

飼養常見的問題如下，給新手參考。
飼養前當然要做足功課，我當初因為是自己的第一隻寵物所以很緊張地找了一堆資料。
																									刺蝟需要的基本用品有:
1.大型整理箱(也有人是買圍籬放養。)
2.墊材:貓砂or尿布墊(貓砂最好選低粉塵的，推薦玉米砂或紙砂)
ps最好不要太香，我當初亂買綠茶砂，第2天我的刺蝟就拉出綠茶砂便便...
3.裝水跟食物的碗，重一點比較不會被頂翻，有人是用菸灰缸。
4.30公分以上大滾輪。網路上比較好找，寵物店很少有賣。
5.保溫燈or暖暖包。刺蝟適宜溫度是25度左右，台灣的天氣絕對需要保暖工具。不過保溫燈之前還滿常有刺友發生電線走火等意外...可以想見箱子裡的小東西有多驚恐!!!所以有些人是堅持用暖暖包+很厚的窩。

刺蝟的飼料挑選:
刺蝟是肉食性的，而且有乳糖不耐症。一般是使用貓飼料無穀雞肉口味搭配各種蟲蟲點心(杜比亞蟑，大麥蟲等等)。

刺蝟的習性:
1.夜行性。我覺得夜行性還滿符合我的生活作息的，就晚上睡覺前抱著她打電腦，跟她玩一下，然後聽著她跑滾輪的聲音入睡。
2.挫青屎。人家緊張就會挫青屎，很黏很深的綠。牠跟你第一次見面難免會這樣，不是生病不要太緊張。
3.舔背，吐泡泡。刺蝟很軟Q，要記味道的時候會把味道舔到背刺上，很萌。
5.鑽鑽，他們愛鑽洞。所以衛生紙捲的心可以給他們玩，品客罐洗乾淨也很好玩~阿排小時候還可以在品客罐裡轉身，現在漲大了要出來都只能倒退嚕了。
4.翻肚。看個性，我家的極力抗拒，不過我男友就特愛翻她。對了，刺蝟水上飄雖然很可愛，但別嘗試，耳朵很容易進水。
其實還有很多有趣的可以講，不過先打這樣吧~大家有反映希望在更深入了解的話我再多說。
最後附上一張欺負她的照片XD

還滿多人問關於蟲的問題，所以我再補充一下:
蟲是野生刺蝟的主食，但對於寵物刺蝟我們無法提供多樣的蟲種，只餵蟲是會營養不良的。所以寵物刺蝟的主食還是飼料，蟲算點心與營養補充品，最營養的種類應該是杜比亞蟑。
還有，水族館購買回來的蟲病菌很多，餵之前先用水果餵養一週之後再餵給刺寶吃比較好。
網路上也有神人自行開發麥皮蟲農場，並自製蟲的果凍控制養出來的蟲的養分，有興趣可以google看看⊙ω⊙','2015-03-20 00:00:00','2015-03-20 00:00:00',5,21,1,'https://imgur.com/7IQpAmf');
...
('2000-10-12','11:00:00','洗澡','阿喵',1,200,'paid',3),
('2000-10-13','12:00:00','洗澡','阿明',1,250,'paid',4),
('2000-10-14','13:00:00','剪髮','彌明',1,200,'paid',3),
('2000-10-15','14:00:00','剪髮','阿中',1,300,'paid',2),
('2000-10-16','15:00:00','造型','小明',1,100,'paid',2),
('2000-10-17','16:00:00','造型','阿中',1,150,'paid',3),
('2000-10-18','17:00:00','造型','阿中',1,100,'paid',4);
