...
<body>
	<center>
	<h3>查詢單筆動物資料</h3>
	<form name="selectOneForm" action="/selectOneAnimal" method="GET">
	...
	<br>
	<h3>查詢所有動物資料</h3>
	<form name="selectOneForm" action="/selectAllAnimal" method="GET">
	...
	<br>
	<h3>刪除動物資料</h3>
	<form name="deleteForm" action="/deleteAnimal" method="GET">
	<input id='num' name="id" value="${param.id}" type="text" size="14" style="text-align: left">
	<input type="submit" value="送出"> 
...
<h3>新增動物資料</h3>
		...
		<form name="updateAnimalForm" action="/updateAnimal" method="POST">
			<table border="1">
				<h3>修改動物資料</h3>
				<tbody>
					<tr bgcolor='tan'>
						...
						<td width="600" height="40" align="left"><input id='num'
							name="id" value="${param.name}" type="text" size="14"
							style="text-align: left">
					</tr>
					<tr bgcolor='tan'>
						<td width="120" height="40">姓名:</td>
