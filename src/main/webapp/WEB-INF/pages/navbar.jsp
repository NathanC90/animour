			...
			<body>
						...
						<div class="collapse navbar-collapse" id="main-menu">
							<ul class="navbar-nav mr-auto w-100 justify-content-end">
								...
								<sec:authorize access="hasRole('Admin')">
									<!-- 管理員可讀 -->
									<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle" href="/user/<sec:authentication property="principal.username"/>"
				...
				<sec:authorize access="hasRole( 'Member') ">
					...
					<li class="nav-item dropdown "><a
						...
						href="/user/<sec:authentication property="principal.username" />" aria-haspopup="true" aria-expanded="false">
								...
								<sec:authorize access="hasRole('Member')">
									<!-- 會員可讀 -->
									<li class="nav-item dropdown">
										<jsp:include page="member/notification.jsp"></jsp:include>
									</li>
									<li class="nav-item dropdown">
										<jsp:include page="member/onlinelist.jsp"></jsp:include>
									</li>
							...
							<ul class="wpb-mobile-menu">
								...
								<li>
									...
									<ul>
										<li>
											<a href="/news/insertNews">新增活動</a>
										</li>
										<li>
											<a href="/news/manage">管理保健</a>
										</li>
									</ul>
								</li>
								<li>
								...
								<sec:authorize access="hasRole('Admin')">
									<!-- 管理員可讀 -->
									<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle" href="/user/<sec:authentication property="principal.username"/>" aria-haspopup="true"
										 aria-expanded="false">
											<sec:authentication property="principal.username" /> 您好
										</a>
										<div class="dropdown-menu">
								...
								<sec:authorize access="hasRole('Member')">
									...
									<li class="nav-item dropdown">
										<a class="nav-link dropdown-toggle" href="/user/<sec:authentication property="principal.username "/>" aria-haspopup="true"
										 aria-expanded="false">
											<sec:authentication property="principal.username" var="username" />${username} 您好
										</a>
										<div class="dropdown-menu">
											<a class="dropdown-item" href="/user/${username}">個人首頁</a>
											<a class="dropdown-item" href="/update">修改個人資料</a>
