...
<!-- 				設計師選擇</h3> -->
<!-- 			<form action="/appointment/showFreeTime" method="GET"> -->
<!-- 				<a class="section-title wow fadeIn animated" data-wow-delay=".2s">小美</a> -->
<!-- 			</form> -->
			
			<h3>設計師選擇</h3>
	<form name="checkFreeTime" action="<c:url value="/appointment/showFreeTime"/>" method="GET">
	<input type="submit" value="查詢所有時間">
	</form>
	<hr>
