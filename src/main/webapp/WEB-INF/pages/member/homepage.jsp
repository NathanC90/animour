...
<body>
	...
	<!-- Header area wrapper ends --> </header>
			...
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body" id="paymentdiv"><table id='showReservation' class="table" data-sort="table"><thead><tr>
									<th>預約日期</th>
									<th>時段</th>
									<th>內容</th>
									<th>設計師</th>
									<th>耗時</th>
									<th>消費金額</th>
									<th>付款狀態</th><th>會員帳號</th></tr></thead></table></div>
				...
				<div class="sidebar-area">
					...
					<ul class="category-menu">
						...
						<c:if test="${member.id eq currentMember.id}">
							...
							<li><a id="checkOrder" href="#" data-toggle="modal"
								data-target="#exampleModal">預約查詢</a></li>
							<li><a href="#">活動紀錄</a></li>
							<li><a href="/update">修改個人資料</a></li>
							<button type="button" class="btn btn-common" data-toggle='modal'
								data-target="#exampleModalMyFriend"
								data-whatever='${currentMember.id}' id="myFriendListbtn">好友清單</button>
						</c:if>
			...
			<div class="col-md-8">
				...
				<div id="portfolio" class="row">
					<c:forEach var="animal" items="${animalls}">
						<div
							class="col-md-3 col-lg-3 col-sm-3 col-xs-12 mix marketing planning"
						...
						<div class="col-md-5 card mb-5 box-shadow">
							...
							<div class="blog-item-wrapper" style="height: 405px;">
								<div class="blog-item-img">
									<a href="/forum/findOne?id=${article.id}"> <img
										style="width: 320px; height: 220px; padding: 10px;"
										src="${article.images}" alt="">
									</a>
								</div>
								<div class="blog-item-text">
									...
									<h3 class="small-title" style="height: 60px;">
										...
										<a href="/forum/findOne?id=${article.id}"
											style="overflow: hidden; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; line-height: 24px; height: 48px;"><c:out
				...
				<div class="modal fade" id="exampleModalMyFriend" tabindex="-1"
					role="dialog" aria-labelledby="exampleModalLabel"
					aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">My Follow
									List</h5>
								<button type="button" class="close" data-dismiss="modal"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
										...
										<div class="card mb-5 box-shadow ">
											<div style="padding: 1px;">
												<a href='/user/${friend.account}'>
													<div
														style="width: 60px; height: 60px; margin: 1px; float: left">
														<img src="${friend.images}" alt="${friend.id}"
